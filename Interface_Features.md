...
## Window level defaults [window-level-defaults]
...
You can switch between preview and source code views with the button in the upper right corner. This view can also be toggled with {% kbd cmd U %}.
...
## Document navigation (TOC, bookmarks, Mini Map) [document-navigation-toc-bookmarks-mini-map]
...
## Collapsible headlines ## [collapsibleheadlines]
...
## Custom Processor indicators/toggles ## [custom-processor-indicatorstoggles]
