...
## When Obsidian's built-in preview is enough
...
* You want publish-quality themes via [Custom Styles](Custom_Styles.html)
...
For a broader comparison including Typora and Marked 2, see the [marketing comparison page](https://markedapp.com/markdown-preview/).
...
1. Write in Obsidian (or Typora, VS Code, etc.) as usual.
2. Drag your vault folder onto Marked, or use the [Marked 3 Obsidian plugin](Obsidian.html).
3. Marked watches the vault and previews the most recently edited note.
4. Use Marked for proofreading, document stats, custom themes, and export when the draft is ready. See [Exporting](Exporting.html).
