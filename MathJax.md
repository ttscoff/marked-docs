...
## Preview formulas with MathJax [preview-formulas-with-mathjax]
...
## MathJax source: Local vs CDN [mathjax-source-local-vs-cdn]
...
## MathJax advanced configuration [mathjax-advanced-configuration]
