...
## What is the Style Stealer? [what-is-the-style-stealer]
...
## How to Use the Style Stealer [how-to-use-the-style-stealer]

### Step 1: Open the Style Stealer [step-1-open-the-style-stealer]

Access the Style Stealer through the **Help** → **Style Stealer**.

### Step 2: Enter a URL [step-2-enter-a-url]
...
### Step 3: Load and Navigate [step-3-load-and-navigate]
...
### Step 4: Extract Styles [step-4-extract-styles]
...
### Pseudo-Selector Support [pseudo-selector-support]
...
### Choose the Right Content Area [choose-the-right-content-area]
...
### Handle Dark Themes [handle-dark-themes]
...
## Integration with Custom Styles [integration-with-custom-styles]
