...
3. Set the secondary format to **Markdown** (see note below about TextBundle).
4. Click the downward arrow beside **Open in** and pick **Marked**.
5. Tab until the primary action reads **Open In**, then confirm.
