...
Marked wird nahezu in Echtzeit aktualisiert und folgt demselben `mkStreamingPreview`-Zwischenablage Schnittstelle wie andere integrierte Apps – siehe [Technical details](Streaming_Preview.html#developers) unter [Streaming Preview](Streaming_Preview.html).
