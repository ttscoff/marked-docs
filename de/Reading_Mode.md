...
- {% kbd h %}: hebt die Auswahl hervor oder schaltet die Hervorhebung der aktuellen Einheit um, wenn nichts ausgewählt ist. {% kbd ? %} öffnet das Hilfe-HUD; `h` übernimmt das im Lesemodus nicht.
