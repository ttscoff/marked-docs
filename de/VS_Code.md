...
1. Installieren Sie eine **Open in Marked**-Erweiterung für VS Code (siehe [Open-in-Marked-Erweiterung][ext] unten).
...
## In der Erweiterung Marked öffnen [open-in-marked-extension]

Die [Open-in-Marked-Erweiterung][ext] (Visual Studio Marketplace) fügt eine Aktion **In Marked öffnen** hinzu: eine Editor-Titelschaltfläche, **{% kbd shift cmd m %}**, Kontextmenüs im Editor und Datei-Explorer, optional **Ordner öffnen** für den Dateibrowser von Marked, eine Statusleistenanzeige und optionales automatisches Speichern vor dem Öffnen. In den Einstellungen können Sie den Pfad zur Marked-App festlegen, wenn diese sich nicht am Standardspeicherort befindet.

I> Die Erweiterung wurde ursprünglich für Marked 2 veröffentlicht. Marked 3 verwendet dieselbe Art der Datei- und URL-Übergabe, sodass diese Integration weiterhin funktioniert. Falls sich etwas ändert, prüfen Sie die [Erweiterungsseite][ext] oder das Repository des Autors auf Aktualisierungen.
