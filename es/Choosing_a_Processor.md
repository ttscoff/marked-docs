...
### ID y encabezados manuales [ids-and-manual-headings]
...
### Cuándo elegir otra cosa [when-to-pick-something-else]
...
### Cuándo elegir otra cosa [when-to-pick-something-else-2]
...
## CommonMark (Marca con sabor a GitHub / cmak-gfm) [commonmark-github-flavored-markdown-cmark-gfm]
...
### Cuándo elegir otra cosa [when-to-pick-something-else-3]
...
### Cuándo elegir otra cosa [when-to-pick-something-else-4]
