...
Actualizaciones marcadas a medida que escribe en The Archive, siguiendo el mismo contrato de portapapeles `mkStreamingPreview` que otras aplicaciones integradas; consulte [Detalles técnicos](Streaming_Preview.html#developers) en [Vista previa de transmisión](Streaming_Preview.html).

Si las vistas previas parecen desactualizadas, confirme que la ventana de transmisión aún esté al frente en Marcado y active el comando de menú Archivo una vez.
