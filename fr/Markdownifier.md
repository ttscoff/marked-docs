...
## Ouverture du Markdownifier [opening-the-markdownifier]
...
## Utilisation du Markdownifier [using-the-markdownifier]
...
### Sélection manuelle du contenu [manual-content-selection]
...
### Intégration du presse-papiers [clipboard-integration]
...
## Traitement du contenu [content-processing]

### Validation automatique du contenu [automatic-content-validation]
...
### Formatage du contenu [content-formatting]
...
## Fonctionnalités de sécurité [safety-features]

### Prévention des accidents [crash-prevention]
...
### Contenu non extrait [content-not-extracted]
...
### Problèmes de WebView [webview-issues]
...
### Intégration avec Marked [integration-with-marked]
...
### Types de contenu pris en charge [supported-content-types]
