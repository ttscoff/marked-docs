...
## Ouvrir un coffre-fort entier [open-an-entire-vault]
...
## Syntaxe des légendes d'Obsidian [obsidian-callout-syntax]
...
## Plugin Obsidian de Marked 3 [marked-3-obsidian-plugin]
...
### Installation à partir des plugins de la communauté [installing-from-community-plugins]

Dans Obsidian, ouvrez **Paramètres → Plugins communautaires**, parcourez ou recherchez **marked** et installez **Open in Marked**.

### Installer manuellement le plugin [manually-installing-the-plugin]
