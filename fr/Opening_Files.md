...
## Workflow de prévisualisation en direct [live-preview-workflow]
...
## Faites glisser vers l'icône du Dock [drag-to-dock-icon]
...
## Utilisation du menu [using-the-menu]
...
## Depuis le Presse-papiers [from-the-clipboard]
...
## Création d'un nouveau document [creating-a-new-document]
