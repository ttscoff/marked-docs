...
### Azonosítók és kézi fejlécek [ids-and-manual-headings]
...
### Mikor válassz valami mást [when-to-pick-something-else]
...
### Mikor válassz valami mást [when-to-pick-something-else-2]
...
## CommonMark (GitHub ízesítésű Markdown / cmark-gfm) [commonmark-github-flavored-markdown-cmark-gfm]
...
### Mikor válassz valami mást [when-to-pick-something-else-3]
...
### Mikor válassz valami mást [when-to-pick-something-else-4]
