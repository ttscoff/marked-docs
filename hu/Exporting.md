...
## Exportálás az előnézet után [export-after-preview]
...
## Az exportálási panel [fiók] [drawer]
...
## A Markdown exportálása PDF-be Mac rendszeren [export-markdown-to-pdf-on-mac]
...
### Dátum és idő formátumok [dateandtimeformats]
...
### Dokumentumonkénti fejlécek és láblécek [per-document-headers-and-footers]
...
## RTF exportálási lehetőségek [rtfexportoptions]
...
## A Markdown exportálása EPUB-ba [export-markdown-to-epub]
...
### Közzététel az Amazon Kindle-ben (KDP) [publishing-to-amazon-kindle-kdp]
...
### Az exportálási profilok használata [using-export-profiles]
...
### Mit rögzítenek az exportprofilok [what-export-profiles-capture]
...
### Profil tárolása [profile-storage]
...
### Tippek az exportprofilok használatához [tips-for-using-export-profiles]
