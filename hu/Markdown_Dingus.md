...
## Az egyéni szabályok nem érvényesek [custom-rules-do-not-apply]
...
## Mi az a "Dingus"? [what-is-a-dingus]
...
## Hozzáférés a Dingushoz [accessing-the-dingus]
...
## Három paneles elrendezés [three-pane-layout]

![][1]

A Dingus ablak három szinkronizált ablaktáblára oszlik:

### 1. Markdown bevitel (bal oldali ablaktábla) [1-markdown-input-left-pane]
...
### 2. HTML-forrás (középső ablaktábla) [2-html-source-middle-pane]
...
### 3. Renderelt előnézet (jobb oldali ablaktábla) [3-rendered-preview-right-pane]
...
## Szerkesztés a Dingusban [editing-in-the-dingus]
...
### Intelligens újsor (Return Key) [smart-newline-return-key]
...
### Karakterpárosítás [character-pairing]
...
### Intelligens URL beillesztése [magic-links-and-footnotes-f6-f7]
...
### Intelligens kiválasztás (⌥⌘↑ / ⌥⌘↓) [smart-url-paste]
...
## A Dingus használata szerkesztőként [using-the-dingus-as-an-editor]
...
### Fájl megnyitása/új fájl létrehozása [opening-a-filecreating-a-new-file]
...
### Előnézet a Megjelöltben [previewing-in-marked]
...
## Processzor kiválasztása [processor-selection]
...
## Miért használja a Dingust? [why-use-the-dingus]

### A processzorok közötti különbségek megértése [understanding-processor-differences]
...
### Teszt írás előtt [testing-before-writing]
...
### Táblázat szintaxisbeli különbségek [table-syntax-differences]
...
### Lábjegyzet támogatás [footnote-support]
