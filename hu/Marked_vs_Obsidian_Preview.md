...
* Nincs szüksége önálló exportálási vagy lektorálási munkafolyamatokra
* Mindent egyetlen alkalmazásban szeretne, minimális beállítással
...
* Speciális lektorálást, dokumentumstatisztikát és kulcsszókiemelést szeretne
* A Markdown mellett a Scrivener, a Word vagy a MarsEdit programokkal dolgozik
* Közzétételi minőségű témákat szeretne a [Custom Styles](Custom_Styles.html) segítségével
...
| :-- | :-- | :-- |
| Élő előnézet bármely Mac szerkesztőből | Igen | Csak Obszidián fájlok |
| Dedikált előnézet + alkalmazás exportálása | Igen | Notes app |
| Egyéni CSS-témák | Igen | Témák/bővítmények |
| Lektori eszközök | Haladó | Alapvető |
| PDF, DOCX, EPUB export | Igen | Bővítmények |
| Scrivener / Word integráció | Igen | Nem |
...
1. Írjon Obsidian (vagy Typora, VS Code stb.) nyelven a szokásos módon.
2. Húzza a Vault mappát a Markedre, vagy használja a [Marked 3 Obsidian plugint](Obsidian.html).
...
* [Obszidián kiemelés szintaxisa](Special_Syntax.html)