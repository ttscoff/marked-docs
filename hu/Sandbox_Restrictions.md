...
## Általános Sandbox korlátozások [common-sandbox-restrictions]

### A Command Binaries futtatása [run-command-binaries]
...
### Megoldások [workarounds]

#### Bináris fájlok másolása az App Bundle csomagba [copying-binaries-to-the-app-bundle]
...
#### Beágyazott szkriptek használata [using-embedded-scripts]
...
### Előfizetéses felhasználóknak [for-subscription-users]
...
### Állandó feloldó tartókhoz [for-permanent-unlock-holders]
