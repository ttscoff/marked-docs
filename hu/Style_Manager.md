...
## A Stíluskezelő megnyitása [opening-the-style-manager]
...
## A stílustáblázat [the-style-table]
...
### Engedélyezve jelölőnégyzet [enabled-checkbox]
...
### Műveletek oszlop [actions-column]
...
## Stílusok átrendezése [reordering-styles]
...
### Sötét mód előnézete [dark-mode-preview]
...
## Letiltott stílusok szűrése [filtering-disabled-styles]
...
## Beépített stílusok visszaállítása [restoring-builtin-styles]
