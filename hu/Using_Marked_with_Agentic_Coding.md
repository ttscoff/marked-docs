...
## A projekt vagy a tervmappa figyelése [watching-your-project-or-plan-folder]
...
## Görgetés az első módosításhoz [scrolling-to-the-first-change]
...
## Diagramok a Mermaid.js segítségével [diagrams-with-mermaidjs]
...
## Példa ügynöki kódolási munkafolyamatokra [example-agentic-coding-workflows]
