...
* Non sono necessari flussi di lavoro di esportazione o correzione di bozze autonomi
* Vuoi tutto in un'unica app con una configurazione minima
...
* Desideri una correzione di bozze avanzata, statistiche dei documenti ed evidenziazione delle parole chiave
* Lavori con Scrivener, Word o MarsEdit insieme a Markdown
* Desideri temi di qualità pubblica tramite [Stili personalizzati](Custom_Styles.html)
...
| :-- | :-- | :-- |
| Anteprima dal vivo da qualsiasi editor Mac | Sì | Solo file ossidiana |
| Anteprima dedicata + app di esportazione | Sì | Applicazione per appunti |
| Temi CSS personalizzati | Sì | Temi/plugin |
| Strumenti di correzione di bozze | Avanzato | Base |
| Esportazione PDF, DOCX, EPUB | Sì | Plugin |
| Integrazione Scrivener / Word | Sì | No |
...
1. Scrivi in ​​Obsidian (o Typora, VS Code, ecc.) come al solito.
2. Trascina la cartella del vault su Marked o utilizza il [plug-in Marked 3 Obsidian](Obsidian.html).
...
* [Sintassi del callout dell'ossidiana](Special_Syntax.html)