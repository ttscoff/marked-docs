...
## Apri un intero caveau [open-an-entire-vault]
...
## Sintassi del callout dell'ossidiana [obsidian-callout-syntax]
...
## Plugin di ossidiana contrassegnato con 3 [marked-3-obsidian-plugin]
...
### Installazione dai plugin della comunità [installing-from-community-plugins]

In Obsidian, apri **Impostazioni → Plug-in della community**, sfoglia o cerca **contrassegnato** e installa **Apri in Contrassegnato**.

### Installazione manuale del plugin [manually-installing-the-plugin]
