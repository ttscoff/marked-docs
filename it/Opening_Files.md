...
## Flusso di lavoro dell'anteprima dal vivo [live-preview-workflow]
...
## Trascina sull'icona del Dock [drag-to-dock-icon]
...
## Utilizzo del menu [using-the-menu]
...
## Dagli Appunti [from-the-clipboard]
...
## Creazione di un nuovo documento [creating-a-new-document]
...
## Nuova visualizzazione nel file corrente [visualizzazione multipla] [multiview]
