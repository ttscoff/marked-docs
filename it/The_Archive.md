...
Aggiornamenti contrassegnati durante la digitazione nell'Archivio, seguendo lo stesso contratto degli appunti `mkStreamingPreview` delle altre app integrate: vedi [Dettagli tecnici](Streaming_Preview.html#developers) in [Anteprima streaming](Streaming_Preview.html).

Se le anteprime sembrano non aggiornate, conferma che la finestra di streaming è ancora in primo piano in Contrassegnato e attiva una volta il comando del menu Archivia.
