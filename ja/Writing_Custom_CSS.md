...
## 追加の CSS 設定 [additional-css-settings]
...
## WebKit インスペクター [webkitinspector]

Safari の Web インスペクターは、マークされた HTML と CSS が生成しているものを正確に確認し、カスタム スタイルをライブで試す最も簡単な方法です。

### Safari で [開発] メニューを有効にする [enabling-the-develop-menu-in-safari]
...
### マークされたドキュメントの検査 [inspecting-a-marked-document]
...
## カスタム CSS の共有 [sharing-custom-css]
...
### 特異性のオーバーライド [overridingspecificity]
...
### 目次のスタイル [table-of-contents-styling]
