...
### Exemplo: alterar estilo de visualização
...
### Exemplo: processador e texto fonte
...
## Rolagem automática e leitura rápida
...
## `with` opções (registro de propriedades)
