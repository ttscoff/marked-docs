...
* Você não precisa de fluxos de trabalho independentes de exportação ou revisão
* Você quer tudo em um aplicativo com configuração mínima

Obsidian (e aplicativos como **Typora**) são uma ótima opção quando uma solução simples e de aplicativo único é tudo que você precisa.

##Quando Marcado é a melhor escolha

* Você deseja uma visualização ao vivo de **qualquer** editor, não apenas do Obsidian
* Você precisa de exportação profissional (PDF, DOCX, EPUB) com CSS personalizado
* Você deseja revisão avançada, estatísticas de documentos e destaque de palavras-chave
* Você trabalha com Scrivener, Word ou MarsEdit junto com Markdown
* Você deseja temas com qualidade de publicação por meio de [Estilos personalizados](Custom_Styles.html)
...
| :-- | :-- | :-- |
| Visualização ao vivo de qualquer editor Mac | Sim | Apenas arquivos obsidianos |
| Visualização dedicada + aplicativo de exportação | Sim | Aplicativo de notas |
| Temas CSS personalizados | Sim | Temas/plug-ins |
| Ferramentas de revisão | Avançado | Básico |
| Exportação de PDF, DOCX, EPUB | Sim | Plug-ins |
| Integração Scrivener/Word | Sim | Não |
...
1. Escreva em Obsidian (ou Typora, VS Code, etc.) como de costume.
2. Arraste a pasta do vault para Marked ou use o [plugin Marked 3 Obsidian](Obsidian.html).
...
* [Sintaxe de texto explicativo Obsidiana](Special_Syntax.html)