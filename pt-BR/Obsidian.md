...
## Abra um cofre inteiro [open-an-entire-vault]
...
## Sintaxe de texto explicativo Obsidian [obsidian-callout-syntax]
...
## Plugin Obsidian marcado como 3 [marked-3-obsidian-plugin]
...
### Instalando a partir de plug-ins da comunidade [installing-from-community-plugins]

No Obsidian, abra **Configurações → Plug-ins da comunidade**, navegue ou pesquise **marcado** e instale **Abrir em Marcado**.

### Instalando manualmente o plugin [manually-installing-the-plugin]
