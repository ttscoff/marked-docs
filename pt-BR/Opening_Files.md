...
## Fluxo de trabalho de visualização ao vivo [live-preview-workflow]
...
## Arraste para o ícone do Dock [drag-to-dock-icon]
...
## Da área de transferência [from-the-clipboard]
...
## Criando um novo documento [creating-a-new-document]
