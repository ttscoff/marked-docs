...
**Apex (beta)** é um dos processadores embutidos. Ele cobre os recursos pelos quais as pessoas costumam escolher CommonMark, GitHub Flavored Markdown, MultiMarkdown ou Kramdown. Veja [Apex (beta)](Apex.html).
