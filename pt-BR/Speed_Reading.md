...
## Como funciona a leitura rápida [how-speed-read-works]
...
## Leitura da velocidade de abertura [opening-speed-read]
...
## Controles de sobreposição [overlay-controls]
...
## Partindo de uma seleção [starting-from-a-selection]
...
## Sincronizando com a posição de rolagem [syncing-with-scroll-position]
...
## Velocidade lembrada [remembered-speed]
