...
### Visualizando o registro [viewing-the-log]
...
### Solução de problemas de regras personalizadas [troubleshooting-custom-rules]
...
### Relatando um problema [reporting-an-issue]
