...
## Configurações ideais [optimal-settings]
...
## Como funcionam os links Wiki [how-wiki-links-work]
...
### Nomes de arquivos correspondentes [matching-file-names]
...
## Histórico de navegação [navigation-history]
